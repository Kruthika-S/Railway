...
const DeleteSpot = () => {
  ...
  useEffect(() => {
    const fetchSpots = async () => {
      try {
        const response = await fetch('https://frontendreact-2.onrender.com/api/admin/spots', {
          credentials: 'include',
        });
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch('https://frontendreact-2.onrender.com/api/admin/delete-spot', {
        method: 'DELETE',
