...
const OwnerBookingPage = () => {
  ...
  const fetchSlots = async () => {
    try {
      const response = await fetch(`https://frontendreact-2.onrender.com/api/owner/slots/${spotName}`, {
  ...
  const handleBook = async (e) => {
    ...
    try {
      const response = await fetch('https://frontendreact-2.onrender.com/api/owner/book', {
        method: 'POST',
        headers: {
...
const handleDeleteSlot = async () => {
  ...
  try {
    const response = await fetch('https://frontendreact-2.onrender.com/api/owner/delete-slot', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
